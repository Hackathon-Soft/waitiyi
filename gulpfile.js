...
gulp.task('beautify:html:index', function () {
...
// beautify:css 
gulp.task('build', gulp.series('clean:dist', 'copy:dist:css', 'copy:dist:html', 'copy:dist:html:index', 'copy:dist:assets', 'minify:css', 'copy:dist:vendor', 'beautify:html', 'beautify:html:index'));
